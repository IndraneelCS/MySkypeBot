...
public class MembersAdded implements Serializable
{
    ...
    private final static long serialVersionUID = 838780597604280728L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MembersAdded) == false) {
            return false;
        }
        MembersAdded rhs = ((MembersAdded) other);
